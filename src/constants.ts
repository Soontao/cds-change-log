...
export const ANNOTATE_CHANGELOG_TO = `${ANNOTATE_CHANGELOG}.to`;
export const ANNOTATE_CHANGELOG_EXTENSION_KEY = `${ANNOTATE_CHANGELOG}.extension.entityKey`;
export const ANNOTATE_CHANGELOG_EXTENSION_KEY_FOR_ASSOCIATION = `${ANNOTATE_CHANGELOG}.extension.for.association`;
